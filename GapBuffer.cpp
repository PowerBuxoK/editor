...
void GapBuffer::grow(size_t size) {
  ...
  memmove(m_data + m_front + m_gap,
          ...
          (old_total - m_front - (m_gap - (m_total - old_total))) *
              sizeof(wchar_t));
}
...
void GapBuffer::moveUp(size_t cursor_x) {
  ...
  moveCursor(static_cast<int>(prev_line_start + target_x) -
             static_cast<int>(m_front));
}
...
void GapBuffer::moveDown(size_t cursor_x) {
  ...
  moveCursor(static_cast<int>(next_line_start + target_x) -
             static_cast<int>(m_front));
}
